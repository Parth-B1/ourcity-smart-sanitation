...
function Home() {
  ...
  // --------------------------------------------------
  // Check latest collection event for citizens
  // --------------------------------------------------
        ...
        <section className="hero-section">
          ...
          <div className="hero-content">
            ...
            <p className="hero-description">
              Report waste, track sanitation
              issues, and know when your
              garbage collection vehicle is
            ...
            <div className="collection-info">
              ...
              {collectionLoading ? (
                ...
                <>
                  ...
                  <p>
                    The next sanitation vehicle
                    is expected in your area today.
                  </p>
                </>
            ...
            >
              ...
              <div>
                ...
                <p>
                  ...
                  sanitation complaints in one place.
                </p>
